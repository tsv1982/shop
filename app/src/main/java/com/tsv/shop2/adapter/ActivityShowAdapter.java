...
public class ActivityShowAdapter extends ArrayAdapter<Customer1> {

    private LayoutInflater inflater;
    private int layout;
    private List<Customer1> customer11List;
    private Util util = new Util();  // нужен сингелтон


    public ActivityShowAdapter(Context context, int resource, List<Customer1> customer11List) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView date_bay_archive = view.findViewById(R.id.date_bay_archive_show);
        TextView sum_price_aechive = view.findViewById(R.id.sum_price_arhive_show);
